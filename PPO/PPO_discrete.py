...
from network import decrete_Policy, StateFunction
...
class PPO_discrete(Algorithm):
    ...
    def update_critic(self, states, targets, log_info):
        ...
        if self.learning_steps_ppo % self.epoch_ppo == 0:
            ...
            log_info['PPO-loss/critic'] = loss_critic.item()
    ...
    def update_actor(self, states, actions, log_pis_old, gaes,log_info):
        ...
        if self.learning_steps_ppo % self.epoch_ppo == 0:
            log_info['PPO-loss/actor'] = loss_actor.item()
