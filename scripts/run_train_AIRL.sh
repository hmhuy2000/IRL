# python train_AIRL.py --env_name=InvertedPendulum-v4 --buffer_size=2000 --eval_interval=5000 \
...
# --num_training_step=1000000 --epoch_disc=5 --lr_disc=0.0001 \
# --buffer_dir='./buffers/InvertedPendulum-v4/1000000.pth' \
# --wandb_logs=True

# python train_AIRL.py --env_name=Hopper-v4 --buffer_size=25000 --eval_interval=50000 \
...
# --num_training_step=3000000 --epoch_disc=10 --lr_disc=0.0005 \
# --buffer_dir='./buffers/Hopper-v4/100000.pth' \
# --wandb_logs=True 

python train_AIRL.py --env_name=CartPole-v1 --buffer_size=2500 --eval_interval=5000 \
...
--num_training_step=1000000 --epoch_disc=10 --lr_disc=0.0001 \
--buffer_dir='./buffers/CartPole-v1/100000.pth' \
--wandb_logs=True 