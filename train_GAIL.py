...
from GAIL.parameter import *
from GAIL.gail_continuous import GAIL_continuous
...
def main():
    ...
    if (wandb_logs):
        ...
        group='GAIL', name=f'{seed}', entity='hmhuy')
    else:
        print('----------------------no Wandb-----------------------')
    ...
    algo = GAIL_continuous(exp_buffer=exp_buffer, state_shape=state_shape, action_shape=action_shape,
            ...
            units_disc=hidden_units_disc,epoch_disc=epoch_disc,lr_disc=lr_disc,
