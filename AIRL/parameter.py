...
training_group.add_argument('--hidden_units_disc_r',type=int,default=100)
training_group.add_argument('--hidden_units_disc_v',type=int,default=100)
...
training_group.add_argument('--weight_path', type=str, default='./weights/AIRL')
...
for _ in range(2):
    ...
    hidden_units_disc_r.append(args.hidden_units_disc_r)
    hidden_units_disc_v.append(args.hidden_units_disc_v)
